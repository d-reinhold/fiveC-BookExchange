class User < ActiveRecord::Base
  ...
  def is_fivec_email
    unless (email.include?("@pomona.edu")) or (email.include?("@mymail.pomona.edu")) or (email.include?("@scripps.edu")) or (email.include?("@hmc.edu")) or (email.include?("@pitzer.edu")) or (email.include?("@cmc.edu"))
