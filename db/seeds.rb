...
dom.listings.create!(:title => "Lolita", :author => "Vladimir Nabokov", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "The Count of Monte Cristo", :author => "Alexandre Dumas", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "The Golden Compass", :author => "Philip Pullman", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "The Stranger", :author => "Albert Camus", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "The Butter Battle Book", :author => "Dr. Seuss", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "The 500 Hats of Bartholomew Cubbins", :author => "Dr. Seuss", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "The Road", :author => "Cormac McCarthy", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "Lord of the Flies", :author => "William Golding", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
...
dom.listings.create!(:title => "The Hyperion Cantos", :author => "Dan Simmons", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "A Confederacy of Dunces", :author => "John Kennedy Toole", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "Common Sense, the Rights of Man and Other Essential Writings of Thomas Paine", :author => "Thomas Paine", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "Declaration of Independence", :author => "Thomas Jefferson", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
dom.listings.create!(:title => "Cat's Cradle", :author => "Kurt Vonnegut", :isbn => random_isbn(r), :price_dollars => random_dollars(r), :price_cents => random_cents(r), :condition => random_condition, :description => random_description )
